...
execute as @a[team=dwarf,scores={drink=0},nbt={SelectedItem:{id:"minecraft:potion",Count:1b,tag:{CustomPotionColor:13077586,display:{Name:"{\"text\":\"Take a drink!\",\"color\":\"green\",\"bold\":\"true\"}",Lore:["Equip to slot 4. Drink to activate"]}}},SelectedItemSlot:3}] run scoreboard players set @s drink 1
execute as @a[team=dwarf,scores={drinkUsed=1,drink=1,drinkTimer=0}] run scoreboard players set @s drinkTimer 1
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:potion",Count:1b,tag:{CustomPotionColor:13077586,display:{Name:"{\"text\":\"Take a drink!\",\"color\":\"green\",\"bold\":\"true\"}",Lore:["Equip to slot 4. Drink to activate"]}}}}]
...
execute as @a[team=dwarf,scores={drink=1},nbt=!{SelectedItem:{id:"minecraft:potion",Count:1b,tag:{CustomPotionColor:13077586,display:{Name:"{\"text\":\"Take a drink!\",\"color\":\"green\",\"bold\":\"true\"}",Lore:["Equip to slot 4. Drink to activate"]}}},SelectedItemSlot:3}] run scoreboard players set @s drink 0
execute as @a[scores={drinkTimer=2..}] if score @s drinkTimer = @s drinkTimerEnd run replaceitem entity @s hotbar.3 minecraft:potion{CustomPotionColor:13077586,display:{Name:"{\"text\":\"Take a drink!\",\"color\":\"green\",\"bold\":\"true\"}",Lore:["Equip to slot 4. Drink to activate"]}} 1
